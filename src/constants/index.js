export const navLinks = [
  ...
  export const myProjects = [
    ...
    {
      title: 'Twitter-Clone - A responsive clone of twitter ',
      desc: 'Twitter-Clone is a fully responsive Twitter UI replica built with Tailwind CSS. Designed for a sleek and modern look, it offers a pixel-perfect layout, smooth responsiveness, and a clean design that adapts seamlessly across all devices.',
      subdesc:
        'Experience a visually stunning and fully responsive Twitter UI built with Tailwind CSS. Designed for smooth navigation and a modern aesthetic, this clone ensures a seamless layout across all screen sizes.',
